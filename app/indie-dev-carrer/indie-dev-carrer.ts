...
@Component({
  selector: 'app-indie-dev-carrer',
  templateUrl: './indie-dev-carrer.html',
  styleUrls: ['./indie-dev-carrer.css'],
  standalone: false,
})
export class IndieDevCarrer implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.lichQueenItems = [
      this.sanitizer.bypassSecurityTrustHtml(
        'Action RPG: Lead developer of an RPG videogame where the player controls a necromancer who builds an army to conquer the world. Part of a team that submitted the game to <a href="https://itch.io/jam/game-off-2023/rate/2398741" target="_blank">Game Off 2023</a>. Responsible for developing most of the codebase, and designing or refining the game systems and behaviors. The game is currently available on <a href="https://bluemoon93.itch.io/the-lich-queen" target="_blank">itch.io</a>.'
      ),
    ];
    ...
    this.xdomeItems = [
      this.sanitizer.bypassSecurityTrustHtml(
        'Online First-Person Shooter: A multi-player game for small teams, developed directly with OpenGL libraries. The goal was to learn the basics of how a game engine actually works, and implementing a distributed solution where multiple clients could play a deathmatch. devlog.'
      ),
    ];
